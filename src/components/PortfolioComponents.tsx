...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="glass p-6 md:p-10 lg:p-12 rounded-[2rem] border border-white/10 relative overflow-hidden bg-white/[0.01] shadow-[0_0_50px_rgba(59,130,246,0.1)]">
          {/* Cyber accents */}
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8 lg:gap-16 relative z-10">
                  ...
                  <div className="relative w-32 h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 shrink-0">
                    ...
                    <div className="absolute inset-0 rounded-full overflow-hidden z-10">
                      <motion.img
                        ...
                        className="w-full h-full object-cover scale-[1.35] object-top translate-y-8 filter grayscale contrast-125 group-hover:grayscale-0 group-hover:scale-[1.45] group-hover:translate-y-2 transition-all duration-700"
                      />
                    </div>
            ...
            <motion.div
              ...
              className="w-full lg:w-64 flex flex-col gap-4 font-mono text-[10px] text-[var(--text-dim)] p-6 glass border-brand-accent/20 shadow-2xl"
            >
